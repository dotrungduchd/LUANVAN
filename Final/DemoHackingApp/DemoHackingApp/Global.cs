...
namespace DemoHackingApp
{
    public class Global
    {
        ...
        public static string HASHKEY02 = "DEF";
        ...
        public static void UpdateHashKey02()
        {
            HashAlgorithm hashAlgor = new SHA256CryptoServiceProvider();
            
            HASHKEY02 = Convert.ToBase64String(hashAlgor.ComputeHash(Encoding.ASCII.GetBytes(KEY02)));
