...
namespace InjectDLL
{
    public class Main : IEntryPoint
    {
            ...
            String InChannelName)
        {
            ...
            try
            {
                ...
                WriteFileHook = LocalHook.Create(LocalHook.GetProcAddress("kernel32.dll", "WriteFile"),
   ...
   [In] ref System.Threading.NativeOverlapped lpOverlapped);
            ...
            [In] ref System.Threading.NativeOverlapped lpOverlapped)
        {
            ...
            if (!string.IsNullOrEmpty(filePath) && CheckExtension(filePath, ext)&& 
                !filePath.Contains("Temporary") && !filePath.Contains("AppData") && !filePath.Contains("~$"))
            {
                try
                {
                    OutputDebugString("W " + nNumberOfBytesToWrite + " - " + filePath);
                    ...
                    if (IV == null)
                    {
                        ...
                        //string filePathToRead = filePath.Replace(@"\\?\", "");
                        string filePathWritten = filePath;

                        if (!string.IsNullOrEmpty(usbDrive))
                        {
                            filePathWritten = filePathWritten.Substring(filePath.IndexOf(usbDrive) + 2);
                        ...
                        //{
                        //    OutputDebugString("W FilePathToRead " + data[0]);
                        ...
                        //        hasIV = true;
                        //        OutputDebugString("W Read IV From file " + data[1]);
                        //    }
                        //}
                        #endregion
                        ...
                        if (!hasIV)
                        {
                            ...
                            OutputDebugString("W Generate IV " + IVstring);
                        }
                    ...
                    if (IV != null)
                        OutputDebugString("W IV: " + IV.Length + " " + This.aes.IV.Length);
                    ...
                    OutputDebugString("W " + resultBlock.Length);
                    #endregion
                }
                catch (Exception ex)
                {
            ...
            [In] ref System.Threading.NativeOverlapped lpOverlapped)
        {
            ...
            {
                OutputDebugString("R " + nNumberOfBytesToRead + " - " + filePath);
                ...
                try
                {
                    ...
                    if (IV == null)
                    {
                        ...
                        if (data != null && data.Length == 3)
                        {
                            ...
                            if (hashKey02.Contains(data[2]))
                            {
                                ...
                                OutputDebugString("R Read IV " + data[1]);
                            }
                        }
                    ...
                    if (IV != null)
                        OutputDebugString("R IV: " + IV.Length + " " + This.aes.IV.Length);
                    ...
                    OutputDebugString("R " + resultBlock.Length);
           ...
           IntPtr lpReserved)
        {
            ...
            try
            {
                ...
                {
                    // Source - Dest
                    OutputDebugString("RP " + lpReplacementFileName + " - " + lpReplacedFileName);
                    ...
                    if (IV == null)
                    {
                        ...
                        OutputDebugString("RP FilePathToReplace " + filePathToReplace);
                        string[] data = FileHelper.ReadFileInfo(metadataFilePath, filePathToReplace).ToArray();

                        // Check filename
                        if (data != null && data.Length == 3)
                        {
                            OutputDebugString("RP data[0] " + data[0]);
                            ...
                            if (hashKey02.Contains(data[2]))
                            {
                                ...
                                OutputDebugString("RP Read IV " + data[1]);
                            }
                        }
                        ...
                        if (!hasIV)
                        {
                            ...
                            OutputDebugString("RP Generate IV " + IVstring);
                        }
                        #endregion
                    ...
                    if (IV != null)
                        OutputDebugString("RP IV: " + IV.Length + " " + This.aes.IV.Length);
                    ...
                    OutputDebugString("RP " + dataToReplace.Length);
            ...
            MoveFileFlags dwFlags)
        {
            ...
            try
            {
                ...
                {
                    // Source - Dest
                    OutputDebugString("M " + lpExistingFileName + " - " + lpNewFileName);
                    string metadataFilePath;
                    string filePathToMove = lpNewFileName;
                    ...
                    if (IV == null)
                    {
                        ...
                        if (data != null && data.Length == 3 && filePathToMove.Contains(data[0]))
                        {
                            ...
                            if (hashKey02.Contains(data[2]))
                            {
                                ...
                                OutputDebugString("M Read IV " + data[1]);
                            }
                        }
                        ...
                        if (!hasIV)
                        {
                            ...
                            string filePathWritten = lpNewFileName;
                    ...
                    if (IV != null)
                        OutputDebugString("M IV: " + IV.Length + " " + This.aes.IV.Length);
                    ...
                    File.WriteAllBytes(lpExistingFileName, dataToMove);
                    OutputDebugString("R " + dataToMove.Length);
                    #endregion
